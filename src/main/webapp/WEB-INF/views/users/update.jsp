...
<body>
  ...
  <script>
    ...
    formEl.addEventListener('submit', function(e) {
    	...
    	// 이전 암호
    	const  inputEl2 = document.querySelector('[name="#pwd1"]')
    	...
    	// db 의 이전암호와 #{ user.passwd } 와 입력한 이전암호가 일치하는지 체크
    	...
    	// 새 암호
    	const  inputEl3 = document.querySelector('[name="#pwd2"]')
    	...
    	// 새 암호확인
    	const  inputEl4 = document.querySelector('[name="#pwd3"]')
